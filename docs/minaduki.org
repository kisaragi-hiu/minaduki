...
Really Minaduki “extensions” are just Emacs files that freely depend on Minaduki's internal utils.

Some commands should be in here instead.

** minaduki-embed-links

Take bare URL links and fetch their titles, giving them titles in the buffer.

** minaduki-timeline

TODO. Very unfinished, including even the concept.
