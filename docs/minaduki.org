...
Pressing the key now will bring up an =emacs-everywhere= window for a [[fleeting note]]. Press =C-c C-c= to finish editing it.

FIXME: aborting the edit does not get rid of the empty file.
