...
Tags are used as meta-data for files: they are shown in the completion, allowing you to
, for example, differentiate between concept notes and literature notes if you store
literature notes in a subdirectory.
