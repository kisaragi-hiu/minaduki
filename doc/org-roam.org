...
3. ~'alias~: This extracts a list of titles using the ~#+alias~ property.
   The aliases are written in individual lines like ~#+title~.
...
1. a symbol -- this symbol corresponds to a title retrieval function, which
  ...
  The currently supported symbols are:
   ...
   ~'alias~
   The ~#+alias~ property of the org file, which can appear multiple times.
